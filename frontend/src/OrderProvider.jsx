...
const OrderProvider = ({children})=>{
    ...
    const initialOrderData = [
        { id: "ORD001", customer: "Achref Hemissi", total: 235.4, status: "Delivered", date: "2023-07-01", products: [{ name: "Milk", quantity: 2, price: 100 }, { name: "Bread", quantity: 1, price: 35.4 }] },
