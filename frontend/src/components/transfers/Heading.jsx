...
import { ArrowUpRight , ArrowDownLeft , ArrowLeftRight, Merge, Trash2 } from "lucide-react";
        ...
        >
            <div className='flex items-center justify-between'>
                <div className="flex items-center">
                    {item.change > 0 ? (
                        <ArrowDownLeft size='60' color="#90EE90" />
                    ) : item.change === 0 ? (
                        <ArrowUpRight size='60' color="#AFEEEE" />
                    ) : item.change === -2 ? (
                        <Merge size='60' color="#FFD700" />
                    ) : item.change === -3 ? (
                        <Trash2 size='60' color="red" />
                    ) : (
                        <ArrowLeftRight size='60' color="#AFEEEE" />
                    )}
