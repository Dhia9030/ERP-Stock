...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-gradient-to-br from-sky-800 to-sky-900 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-gray-700 mb-8'
